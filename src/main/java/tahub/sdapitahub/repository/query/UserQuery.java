...
public enum UserQuery {
    ...
    SAVE("INSERT INTO ta_users (role_id, first_name, last_name, username, email, phone, reset_token, password_hash, is_active, g_access_token, g_access_token_created_at, g_token_expires_in, g_id_token, current_session_id, last_login_time, created_at, last_updated) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"),
